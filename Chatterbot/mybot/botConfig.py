...
myBotName = "Healthcare Bot"
botTimeZone = "America/New_York"  ##See the list full below
botAvatar = "/static/hcbot.png" ##This can either be an image in your static folder or a web url to an image
chatBG = "/static/hcbg.jpg"  ##This can either be an image in your static folder or a web url to an image
